            ...
            <div class="p-4">
                ...
                <nav>
                    ...
                    <a href="{{ route('admin.homepage.index') }}"
                        class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors mb-1 
                       {{ request()->routeIs('admin.homepage.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-blue-600' }}">
                        <div class="w-5 flex justify-center">
                            <i class="fas fa-layer-group {{ request()->routeIs('admin.homepage.*') ? 'text-white' : '' }}"></i>
                        </div>
